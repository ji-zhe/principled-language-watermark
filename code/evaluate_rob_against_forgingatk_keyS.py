...
def forging_attack(data, batch_size=10):
...
def evaluate(data_source, out_file, batch_size=10, on_train=False):
    ...
    for i in range(0, data_source.size(0) - args.bptt, args.bptt):
        ...
        with torch.no_grad():
            ...
            print(i)			
            data_adv_autoenc, atk_msgs = forging_attack(best_beam_data, batch_size)
            long_msg_atk[:,long_msg_count*args.msg_len:long_msg_count*args.msg_len+args.msg_len] = atk_msgs.cpu()
            ...
            msg_out,_ = model_gen.forward_msg_decode(data_dv_autoenc_emb.detach(), keys)
            msg_out_atk, _ = model_gen.forward_msg_decode(data_dv_autoenc_emb.detach(), best_beam_emb)
            ...
            if bert_diff_selected < args.bert_threshold:
                ...
                msg_out_random, _ =  model_gen.forward_msg_decode(data_emb, keys)
