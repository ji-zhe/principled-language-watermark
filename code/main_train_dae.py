...
def evaluate(data_source, batch_size=10):
    ...
    for i in range(0, data_source.size(0) - args.bptt, args.bptt):
        ...
        out_data_prob = model_gen.forward_sent(data,data_noise,args.gumbel_temp, is_embedding=False)
...
# s -> hiding -> x -> attacker -> y
# model_gen = attacker
        errG.backward()
        # update the generator #
        # print(list(model_gen.sent_decoder.parameters())[-1])
        # print(list(model_gen.sent_decoder.parameters())[-1].grad)
        optimizer_gen.step()
