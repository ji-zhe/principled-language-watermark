...
def model_save(fn):
    ...
    with open(fn+'_mine_uy.pt', 'wb') as f:
        torch.save(mine_uy,f)
    with open(fn+'_mine_us.pt', 'wb') as f:
        torch.save(mine_us,f)
...
mine_us = mine.Mine(model_mine.MI_feature2seq(args.emsize, args.dropout_transformer,args.attn_heads, args.encoding_layers), loss='mine').cuda()
###
if not criterion:
...
###
params = list(model_gen.parameters()) + list(criterion.parameters()) + list(criterion_reconst.parameters()) + list(criterion_label.parameters()) + list(model_atk.parameters()) + list(mine_us.parameters())+list(mine_uy.parameters()) + list(model_disc.parameters())
...
def evaluate(data_source, batch_size=10):
    ...
    with torch.no_grad():
        for i in range(0, data_source.size(0) - args.bptt, args.bptt):
            ...
            msg_out, labels_out = model_gen.forward_msg_decode(msg_dec_input)
            msg_out_2, labels_out_2 = model_gen.forward_msg_decode(fake_data_emb)
            ...
            total_mine_us += -mine_us(fake_sent_msg_embedding, data_emb.permute((1,0,2)))
...
def train():
	...
	#get the embeddings from the generator network of the real 
        ...
        mine_us.optimize(fake_sent_msg_embedding.detach(), data_emb.detach().permute((1,0,2)), iters=2, batch_size=fake_data_emb.size(1),opt=optimizer_mine_us) ### : batch first! 
        utils.freeze(mine_uy)
        utils.freeze(mine_us)
        ...
        # errG_reconst = torch.relu(criterion_reconst(fake_data_prob,data.view(-1)) - args.D1_thres)
        errG_reconst = criterion_reconst(fake_data_prob,data.view(-1)) #S, X distortion
        errG_mi = -(mine_us(fake_sent_msg_embedding, data_emb.permute((1,0,2))) - mine_uy(fake_sent_msg_embedding,atk_data_emb.permute((1,0,2)))) # min -(I(U;Y) - I(U;S)) # J =  I(U;Y) - I(U;S)

        msg_out_clean, labels_out_clean = model_gen.forward_msg_decode(fake_data_emb)
        ...
        if batch % args.log_interval == 0 and batch > 0:
            ...
            print('| epoch {:3d} | {:5d}/{:5d} batches | gen lr {:05.5f} | ms/batch {:5.6f} | '
                    'msg loss {:5.6f} | msg label loss {:5.6f} | sem loss {:5.6f} | reconst loss {:5.6f} | lm loss {:5.6f} | errA_mi -- | errA_reconst {:5.6f}| msg_1 loss {:5.6f} | msg_2 loss {:5.6f}  | gen loss {:5.6f} | disc loss {:5.6f}'.format(
                epoch, batch, len(train_data) // args.bptt, optimizer_gen.param_groups[0]['lr'],
                elapsed * 1000 / args.log_interval, cur_loss_msg, cur_loss_msg_label, cur_loss_sem, cur_loss_reconst, cur_loss_lm, errA_reconst, cur_loss_msg_1, cur_loss_msg_2, cur_loss_gen, cur_loss_disc))
            total_loss_gen = 0
            total_loss_msg = 0
            total_loss_msg_label = 0
            total_loss_disc = 0
...
try:
    ...
    optimizer_mine_us = torch.optim.Adam(mine_us.parameters(), lr=1e-4)
    for epoch in range(1, args.epochs+1):
        ...
        if 't0' in optimizer_gen.param_groups[0]:
            ...
            val_loss_reconst, val_loss_msg, val_loss_msg_label, val_loss_mine_us,val_loss_mine_uy, val_loss_sem, val_loss_lm, val_loss_msg_1, val_loss_msg_2, val_loss_gen, val_loss_disc = evaluate(val_data, eval_batch_size)
            val_loss_gen_tot2 = args.reconst_weight * val_loss_reconst + args.msg_weight * val_loss_msg + args.xsmi_weight * (val_loss_mine_us - val_loss_mine_uy) + args.sem_weight * val_loss_sem + args.lm_weight * val_loss_lm + args.gen_weight * val_loss_gen

            print('-' * 89)
            print('| end of epoch {:3d} | time: {:5.6f}s | val_loss_reconst: {:5.6f} | val_loss_msg: {:5.6f} | val_loss_msg_label: {:5.6f} | val_loss_mine_us: {:5.6f} | val_loss_mine_uy: {:5.6f} | val_loss_sem: {:5.6f} | val_loss_lm: {:5.6f} | val_loss_msg_1: {:5.6f} | val_loss_msg_2: {:5.6f} | val_loss_gen: {:5.6f}'.format(
                    epoch, (time.time() - epoch_start_time),val_loss_reconst, val_loss_msg, val_loss_msg_label, val_loss_mine_us,val_loss_mine_uy, val_loss_sem, val_loss_lm, val_loss_msg_1, val_loss_msg_2, val_loss_gen))
            print('-' * 89)
            ...
            val_loss_reconst, val_loss_msg, val_loss_msg_label, val_loss_mine_us,val_loss_mine_uy, val_loss_sem, val_loss_lm,val_loss_msg_1, val_loss_msg_2, val_loss_gen, val_loss_disc = evaluate(val_data, eval_batch_size)
            val_loss_gen_tot = args.reconst_weight * val_loss_reconst + args.msg_weight * val_loss_msg + args.xsmi_weight * (val_loss_mine_us - val_loss_mine_uy)+ args.sem_weight * val_loss_sem + args.lm_weight * val_loss_lm + args.gen_weight * val_loss_gen
            val_loss_text = val_loss_reconst
            print('-' * 89)
            print('| end of epoch {:3d} | time: {:5.6f}s | val_loss_reconst: {:5.6f} | val_loss_msg: {:5.6f} | val_loss_msg_label: {:5.6f} | val_loss_mine_us: {:5.6f} | val_loss_mine_uy: {:5.6f} | val_loss_sem {:5.6f} |  val_loss_lm {:5.6f} | val_loss_msg_1: {:5.6f} | val_loss_msg_2: {:5.6f} | val_loss_gen: {:5.6f} | val_loss_disc: {:5.6f}'.format(
                    epoch, (time.time() - epoch_start_time),val_loss_reconst, val_loss_msg, val_loss_msg_label, val_loss_mine_us,val_loss_mine_uy,val_loss_sem, val_loss_lm, val_loss_msg_1, val_loss_msg_2, val_loss_gen, val_loss_disc))
            print('-' * 89)
...
# Run on test data.
test_loss_reconst, test_loss_msg, test_loss_msg_label, test_loss_mine_us,test_loss_mine_uy, test_loss_sem, test_loss_lm, test_loss_msg_1, test_loss_msg_2, test_loss_gen, test_loss_disc = evaluate(test_data, test_batch_size)

print('-' * 89)
print('| end of training  {:3d} | time: {:5.6f}s | test_loss_reconst: {:5.6f} | test_loss_msg: {:5.6f} | test_loss_msg_label: {:5.6f} | test_loss_mine_us: {:5.6f} | test_loss_mine_uy: {:5.6f} | test_loss_sem: {:5.6f} | test_loss_lm: {:5.6f} | test_loss_msg_1: {:5.6f} | test_loss_msg_2: {:5.6f}| test gen loss {:5.2f} | test disc loss {:5.2f} '.format(
        epoch, (time.time() - epoch_start_time),test_loss_reconst, test_loss_msg, test_loss_msg_label, test_loss_mine_us,test_loss_mine_uy, test_loss_sem, test_loss_lm, test_loss_msg_1, test_loss_msg_2, test_loss_gen, test_loss_disc))
print('-' * 89)
